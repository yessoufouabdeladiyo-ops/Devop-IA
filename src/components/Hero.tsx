  ...
  return (
    <section id="accueil" className="relative overflow-hidden bg-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -top-28 end-[-10%] h-[380px] w-[380px] rounded-full bg-flame/10 blur-3xl" />
        <div className="absolute bottom-[-20%] start-[-8%] h-[340px] w-[340px] rounded-full bg-ember/5 blur-3xl" />
      </div>
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
          ...
          <div className="max-w-xl">
            ...
            <h1
              ...
              style={d(90)}
            >
              <span className="block text-ink">{T.hero.titleLine1}</span>
              <span className="block text-ember">
                {T.hero.accentFirst ? (
                  <>
                    <span className="text-flame">{T.hero.titleAccent}</span>{" "}
                    {T.hero.titleRole}
                  </>
                ) : (
                  <>
          ...
          >
            ...
            <div className="absolute -end-3 top-8 flex items-center gap-2 rounded-2xl border border-ember/10 bg-white/95 px-4 py-2.5 shadow-lg shadow-ember/10 backdrop-blur-sm sm:-end-4">
              <i
            ...
            <div className="absolute -start-3 bottom-8 flex items-center gap-2 rounded-2xl border border-ember/10 bg-white/95 px-4 py-2.5 shadow-lg shadow-ember/10 backdrop-blur-sm sm:-start-4">
              <i
