      ...
      <div className="mx-auto max-w-6xl px-5 pb-20 pt-4 sm:px-8 sm:pb-24 lg:pb-28">
        <Reveal>
          ...
          <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#ff7c30] via-[#f06318] to-[#cd4c00] px-6 py-16 shadow-[0_40px_80px_-40px_rgba(205,76,0,0.65)] sm:px-12 sm:py-20">
            ...
            >
              <div className="absolute -end-24 -top-24 h-[340px] w-[340px] rounded-full bg-white/10 blur-3xl" />
              <div className="absolute -bottom-28 -start-20 h-[320px] w-[320px] rounded-full bg-white/[0.07] blur-3xl" />
            ...
            <div className="relative mx-auto max-w-2xl text-center">
              ...
              <div className="mt-9">
                <a
                  ...
                  className="group inline-flex items-center gap-3 rounded-full bg-[#ffffff] px-8 py-4 font-display text-[15.5px] font-bold text-ember shadow-[0_18px_40px_-18px_rgba(0,0,0,0.45)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#ffffff] hover:text-flame-deep hover:shadow-[0_24px_50px_-18px_rgba(0,0,0,0.55)] sm:text-[16px]"
                >
                  {T.finalCta.cta}
                  <span
