  ...
  return (
    <section id="methode" className="relative overflow-hidden bg-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute start-1/2 top-24 h-[380px] w-[620px] -translate-x-1/2 rounded-full bg-flame/[0.06] blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-24 lg:py-28">
        ...
        <div className="relative mt-20 hidden lg:block">
          ...
          <div
            aria-hidden="true"
            className="absolute inset-x-0 top-[27px] h-[2px] bg-gradient-to-r from-flame/15 via-flame/45 to-flame/15"
          />
        ...
        <div className="relative mt-14 lg:hidden">
          ...
          <div
            aria-hidden="true"
            className="absolute bottom-6 start-[27px] top-4 w-[2px] bg-gradient-to-b from-flame/15 via-flame/45 to-flame/15"
          />
        ...
        <Reveal delay={260} className="mt-16 text-center">
          ...
          >
            ...
            {T.process.cta}
            <i
              className="fa-solid fa-arrow-right text-[15px] transition-transform duration-300 ltr:group-hover:translate-x-1 rtl:-scale-x-100 rtl:group-hover:-translate-x-1"
              aria-hidden="true"
            />
          </a>
        </Reveal>
