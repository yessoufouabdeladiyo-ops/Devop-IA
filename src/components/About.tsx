  ...
  return (
    <section id="a-propos" className="relative overflow-hidden bg-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -start-28 top-16 h-[320px] w-[320px] rounded-full bg-flame/[0.07] blur-3xl" />
        <div className="absolute -end-28 bottom-10 h-[320px] w-[320px] rounded-full bg-ember/[0.06] blur-3xl" />
      </div>
